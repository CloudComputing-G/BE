package cloudproject.com.application.assignment.service;

import cloudproject.com.application.ClassStudentRepository;
import cloudproject.com.application.UserRepository;
import cloudproject.com.application.assignment.dto.request.AssignmentCreateRequest;
import cloudproject.com.application.assignment.dto.request.AssignmentUpdateRequest;
import cloudproject.com.application.assignment.dto.request.QuestionUpdateRequest;
import cloudproject.com.application.assignment.dto.response.AssignmentResponse;
import cloudproject.com.application.assignment.repository.SubmissionRepository;
import cloudproject.com.application.domain.Assignment;
import cloudproject.com.application.domain.Question;
import cloudproject.com.application.assignment.repository.AssignmentRepository;
import cloudproject.com.application.assignment.repository.QuestionRepository;
...
public class AssignmentService {
    ...
    public List<AssignmentResponse> getAssignments(Long classId, Long teacherId){
        ...
        // 반 전체 학생 수
        long totalCount = classStudentRepository.countByClassEntity_ClassId(classId);
        //반별 과제 목록
        return assignmentRepository.findByClassEntity_ClassIdAndTeacher(classId, teacher)
                .stream()
                .map(assignment -> {
