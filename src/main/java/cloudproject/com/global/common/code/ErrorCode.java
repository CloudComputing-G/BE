...
public enum ErrorCode implements BaseCode {
    ...
    // Assignment
    ASSIGNMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "A001", "과제를 찾을 수 없습니다."),
    // DRAFT 상태만 수정/삭제 가능한데 PUBLISHED 상태에서 시도할 때
    ASSIGNMENT_ALREADY_PUBLISHED(HttpStatus.BAD_REQUEST, "A002", "이미 게시된 과제입니다."),
    ASSIGNMENT_FORBIDDEN(HttpStatus.FORBIDDEN, "A003", "해당 과제에 대한 권한이 없습니다."),
